...
function updateViewer(id) {
  ...
  if (diffView == "k") {
	  ...
	  download = "http://patch.dc.nextfloor.com/real_1.3.57.z5hw32cgr7b3/hd_android/asset/character/" + selectedModel +".pck"
	  ...
	  download = "http://patch.dcg.line.games/real_0.0.72.vjmsl18zxt3f/hd_mobile/asset/character/" + selectedModel +".pck"
