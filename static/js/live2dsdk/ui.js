...
function updateViewer(id) {
  ...
  if (diffView == "k") {
	  ...
	  download = "http://patch.dc.nextfloor.com/1.3.49.vfexj3r0f3z9/hd_android/asset/character/" + selectedModel +".pck"
	  ...
	  download = "http://patch.dcg.line.games/real_0.0.59_nenqkoh6ntjt/hd_mobile/asset/character/" + selectedModel +".pck"
